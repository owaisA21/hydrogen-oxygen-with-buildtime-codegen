...
import sty from "./PlasmicSelect__OptionGroup.module.css"; // plasmic-import: wY5rBdTEFQJ/css

import SUPER__PlasmicSelect from "./PlasmicSelect"; // plasmic-import: l68XploTi1A/render
      ...
      >
        {renderPlasmicSlot({
          defaultContents: (
            <React.Fragment>
              <Select__Option
                className={classNames("__wab_instance", sty.option__kwFyt)}
              />

              <Select__Option
                className={classNames("__wab_instance", sty.option__keiu8)}
              />
            </React.Fragment>
          ),
          value: args.children
